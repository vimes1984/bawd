...
angular.module('bawdApp')
  .controller('MenuCtrl', function ($scope, $location, $rootScope, $route, $animate) {
          if($location.path() === '/home'){
            $('.closeX').hide();
              var getpantones = $('.container');
              $animate.addClass(getpantones, 'bounceIn animated');
          }
          $scope.togglethis  = function togglethis(){
              ...
              $animate.addClass(getlogo, 'fadeIn animated');
          ...
          $scope.closemenu = function closemenu(){
            ...
            $animate.removeClass(getlogo, 'fadeIn animated');
            $animate.addClass(getlogo, 'fadeOut animated');
            ...
            $animate.leave(getpantones,function(){
              ...
              $animate.removeClass(getlogo, 'fadeOut animated');
